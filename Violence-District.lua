...
-- ✅ PLAYER NAMETAG + FULL ESP - 100% FIXED (NO MORE END OVERFLOW)
local function UpdatePlayerESP(p)
    pcall(function()
        ...
        -- 🔥 CHASED INDICATOR + OFFSCREEN ARROW
